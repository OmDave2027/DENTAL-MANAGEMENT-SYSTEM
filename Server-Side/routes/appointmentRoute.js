...
router.post("/", authMiddleware, [
  ...
  try {
    ...
    const [result] = await connection.query(
      ...
      [userId, appointment_date, appointment_time, appointment_type, dentist_name, notes]
    );
...
router.put("/:id", authMiddleware, async (req, res) => {
  try {
    ...
    await connection.query(
      ...
      [appointment_date, appointment_time, appointment_type, dentist_name, notes, status, id]
    );
